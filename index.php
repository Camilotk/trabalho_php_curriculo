        ...
        <form action="middleware.php" method="post">
            <div id="basic-form" class="quadro-informacoes informacoes-pesssoais">
                ...
                <div class="row">
                    <div class="form-group col-sm-12">
                        ...
                        <input class="form-control" name="nome_completo" minlenght="2" maxlenght="250"
                            placeholder="Nome" novalidate>
                    </div>
                    ...
                    <div class="form-group col-sm-6">
                        ...
                        <input class="form-control" type="tel" name="telefone" minlenght="9" maxlenght="14"
                            placeholder="Telefone/Celular" novalidate>
                    </div>
            ...
            <div id="information-form" class="quadro-informacoes informacoes-contato escondido">
                ...
                <div class="container-botoes">
                    ...
                    <input id="information-to-experience" class="btn btn-primary botao-proximo" type="button"
                        value="Próximo">
            ...
            <div id="experience-form" class="quadro-informacoes informacoes-experiencias escondido">
                ...
                <p class="quadro-informacoes-descricao">
                    Nos conte sobre suas experiências profissionais. Descreva suas atividades e conquistas. Estes itens
                    são
                ...
                <div class="container-botoes">
                    ...
                    <input id="experience-to-formation" class="btn btn-primary botao-proximo" type="button"
                        value="Próximo">
            ...
            <div id="extra-form" class="quadro-informacoes informacoes-extra escondido">
                ...
                <div class="container-botoes">
                    ...
                    <input id="extras-to-habilities" class="btn btn-primary botao-proximo" type="button"
                        value="Próximo">
            ...
            <div id="habilities-form" class="quadro-informacoes informacoes-habilidades escondido">
                ...
                <div class="container-botoes">
                    ...
                    <input id="habilities-to-resume" class="btn btn-primary botao-proximo" type="button"
                        value="Próximo">
            ...
            <div id="resume-form" class="quadro-informacoes informacoes-resumo escondido">
                ...
                <p class="quadro-informacoes-descricao">
                    Faça um breve resumo do seu currículo e de sua trajetória profissional, destacando seus
                    diferenciais.
                </p>
                <div class="row">
                    <div class="form-group col-sm-12">
